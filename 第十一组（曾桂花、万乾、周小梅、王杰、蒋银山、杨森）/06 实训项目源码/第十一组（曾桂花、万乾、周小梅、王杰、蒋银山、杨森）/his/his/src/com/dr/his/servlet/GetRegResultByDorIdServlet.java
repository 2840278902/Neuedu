...
@WebServlet("/getRegResult")
public class GetRegResultByDorIdServlet extends HttpServlet{
	@Override
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if(!"".equals(doctorId) && null != doctorId) {
			...
			List<RegisterEntity> registerList = registerService.getWaitRegisterByDorIdCommon(doctorId,1);//1表示已诊断
